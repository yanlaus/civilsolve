...
| Gemini | Google (switchable to Poe) | `gemini-3.8-flash`, falling back to `gemini-3.5-flash` | **reader and judge only** since 26 September 2026 - the free-tier key answers 503 "high demand" more often than not; marked "free but unstable" in those lists |
...
| Kimi | OpenCode Go | `kimi-k2.7-code`, medium thinking or above, 20-minute timeout | **selected** - took Gemini's place as a default solver on 26 September 2026 |
